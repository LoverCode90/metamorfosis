    ...
    <header className="border-border bg-background/85 supports-[backdrop-filter]:bg-background/70 sticky top-0 z-40 border-b backdrop-blur">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          >
            <Search className="h-8 w-8 sm:h-5 sm:w-5" strokeWidth={1.5} />
          </HeaderIconButton>
          ...
          <HeaderIconButton
            ...
            className="hidden sm:flex"
          >
            <Heart className="h-8 w-8 sm:h-5 sm:w-5" strokeWidth={1.5} />
          </HeaderIconButton>
          ...
          >
            <ShoppingBag className="h-8 w-8 sm:h-5 sm:w-5" strokeWidth={1.5} />
          </HeaderIconButton>
          ...
          {isAuthenticated ? (
            <HeaderIconButton
              ...
              className="hidden sm:flex"
            >
              <User className="h-8 w-8 sm:h-5 sm:w-5" strokeWidth={1.5} />
            </HeaderIconButton>
          ) : (
            <Button
              variant="outline"
          ...
          >
            <Menu className="h-8 w-8 sm:h-5 sm:w-5" strokeWidth={1.5} />
          </Button>
        </div>
      </div>
