      ...
      <section className="bg-foreground relative flex min-h-[88vh] items-end overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-4 pb-24 sm:px-6 xl:max-w-7xl">
          ...
          <p className="mt-5 max-w-lg text-sm leading-relaxed text-pretty text-white/65 sm:text-base">
            Permanent crème color, bond care, and professional tools —
            engineered for colorists who refuse to compromise.
          </p>
          ...
          <div className="border-border bg-border mt-10 grid grid-cols-1 gap-px overflow-hidden rounded-2xl border sm:grid-cols-2">
            {[
              ...
              >
                ...
                <span
                  className={[
                    "transition-gap mt-8 inline-flex items-center gap-1.5 text-xs font-semibold group-hover:gap-2",
