...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        "text-muted-foreground relative inline-flex h-[calc(100%-2px)] flex-1 items-center justify-center gap-1.5 rounded-md border border-transparent px-2 py-0.5 text-sm font-medium whitespace-nowrap transition-all",
        ...
        "after:bg-ring after:absolute after:opacity-0 after:transition-opacity",
...
function TabsContent({ className, ...props }: TabsPrimitive.Panel.Props) {
  return (
    <TabsPrimitive.Panel
      ...
      className={cn("text-foreground flex-1 text-sm outline-none", className)}
      {...props}
    />
  )
}
