    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "border-border bg-popover text-popover-foreground rounded-xl border p-5 text-sm shadow-lg",
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "border-border bg-muted/40 -mx-5 -mb-5 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
