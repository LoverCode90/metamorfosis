...
export const BRAND_LINES: BrandLine[] = [
  {
    slug: "brazilian-nano",
    name: "Brazilian Nano",
    description: "Nanoplastia profesional.",
  ...
  },
  {
    slug: "nutrapel",
    name: "Nutrapel",
    description: "Línea especial para reparación capilar.",
  ...
  },
  {
    slug: "earthia-colors",
    name: "Earthia Colors",
    description: "Tintes libre de amoniaco.",
  ...
  },
  {
    ...
    name: "BBCos",
    description:
      "Alta gama para el cuidado y tratamiento del cabello con tecnología avanzada.",
  ...
  },
  {
    slug: "level-3",
    name: "Level 3",
    description: "Geles y fibras técnicas para styling profesional.",
