...
export function buildCaseFraudHtml(data: CaseFraudData): string {
  const body = `${emailIntro(
    ...
    `Hi ${data.customerName}, due to inconsistencies between the submitted photos and the actual condition of your item (${data.itemDescription}), your request has been denied. If you believe this is an error, please contact us.`,
  )}
...
Due to inconsistencies between the submitted photos and the actual condition of your item (${data.itemDescription}), your request has been denied. If you believe this is an error, please contact us.
